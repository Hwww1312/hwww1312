...
export const CHAPTERS: ChapterConfig[] = [
  {
    ...
    range: [0, 0.14],
    state: {
      cameraPosition: [0.15, 1.35, 3.4],
      cameraLookAt: [0, 0.15, 0],
      modelPosition: [0.35, -0.05, 0],
      modelRotation: [0.15, -0.35, 0.05],
      modelScale: 1.15,
      lightIntensity: 1.35,
  ...
  },
  {
    ...
    range: [0.14, 0.3],
    state: {
      cameraPosition: [-1.2, 1.1, 2.8],
      cameraLookAt: [0.1, 0.1, 0],
      modelPosition: [0.55, 0, 0.1],
      modelRotation: [0.05, 0.85, 0],
      modelScale: 0.95,
      lightIntensity: 1.15,
      accentIntensity: 0.7,
      dishIndex: 1,
  ...
  },
  {
    ...
    range: [0.3, 0.5],
    state: {
      cameraPosition: [0.4, 0.85, 1.55],
      cameraLookAt: [0, 0.22, 0],
      modelPosition: [-0.15, 0.05, 0],
      modelRotation: [0.55, -0.2, 0.1],
      modelScale: 1.35,
      lightIntensity: 1.6,
  ...
  },
  {
    ...
    range: [0.5, 0.68],
    state: {
      cameraPosition: [0, 2.2, 2.4],
      cameraLookAt: [0, 0.3, 0],
      modelPosition: [0, 0.15, 0],
      modelRotation: [0.1, Math.PI * 0.35, 0],
      modelScale: 1.05,
      lightIntensity: 1.8,
      accentIntensity: 1.2,
      dishIndex: 3,
  ...
  },
  {
    ...
    range: [0.68, 0.86],
    state: {
      cameraPosition: [2.1, 1.4, 2.6],
      cameraLookAt: [-0.2, 0.1, 0],
      modelPosition: [-0.85, -0.05, 0],
      modelRotation: [0.2, -1.1, 0.05],
      modelScale: 0.72,
      lightIntensity: 1.05,
  ...
  },
  {
    ...
    range: [0.86, 1],
    state: {
      cameraPosition: [0.05, 1.55, 3.1],
      cameraLookAt: [0, 0.12, 0],
      modelPosition: [0, -0.02, 0],
      modelRotation: [0.12, 0.25, 0],
      modelScale: 1.2,
      lightIntensity: 1.45,
      accentIntensity: 0.8,
      dishIndex: 0,
