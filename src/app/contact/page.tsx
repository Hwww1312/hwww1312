    ...
    <div className="mx-auto max-w-[1440px] px-5 pb-28 pt-[22vh] sm:px-8">
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-7">
          ...
          <p className="mt-6 max-w-[52ch] text-base leading-relaxed text-sage">
        ...
        <aside className="lg:col-span-4 lg:col-start-9">
          ...
          <dl className="mt-6 divide-y divide-ivory/15 border-y border-ivory/15 text-base">
            <div className="py-4">
              ...
              <dd className="mt-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-3 block text-[15px] underline decoration-lemongrass/45 underline-offset-4 hover:decoration-lemongrass"
                >
                  Get directions
                </a>
              </dd>
            ...
            <div className="py-4">
              ...
              <dd className="mt-2">
                <a
                  ...
                  className="underline decoration-lemongrass/45 underline-offset-4 hover:decoration-lemongrass"
                >
            ...
            <div className="py-4">
              <dt className="text-sm uppercase tracking-[0.14em] text-sage">Service</dt>
