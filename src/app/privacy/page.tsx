...
export default function PrivacyPage() {
  return (
    <div className="shell max-w-[70ch] pb-28 pt-[22vh]">
      ...
      <div className="mt-10 space-y-6 text-base leading-relaxed text-ink-soft">
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">What we collect</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">What we do with it</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold tracking-tight text-ink">Tracking</h2>
        <p>
        ...
        <p className="border-l-2 border-jade py-3 pl-4 text-sm text-ink">
